    ...
    {(childName, getToken, access, activeChildId, childrenList, userEmail) => (
      <>
        ...
        <main id="main-content">
          <AppLoader App={App} currentUser={childName} getToken={getToken} activeChildId={activeChildId} childrenList={childrenList || []} userEmail={userEmail || ''} tutorEligible={access?.tutorEligible || false} />
          <DevReviewPanel />
        </main>
      </>
    )}
