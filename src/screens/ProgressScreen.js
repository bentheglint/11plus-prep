...
function ProgressScreen({ quizHistory, questionData, mastery, streaksAndPP, userData, currentUser, getToken, activeChildId, onHome, onStartTopic, onDrillDown, onViewQuiz, onViewAllActivity, onOpenParentMessages, entitlement, freeTierActive, onUpgrade }) {
  const initialView = (() => {
    ...
    <div className="app-bg min-h-screen">
      ...
      {view === 'parent' ? (
        <ParentDashboard
          ...
          onHome={onHome}
          onOpenParentMessages={onOpenParentMessages}
