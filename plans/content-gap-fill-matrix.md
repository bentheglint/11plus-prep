...
| 2.4 | M11 Nth-term expressions | `sequences` | 152 | 153 | Reuse `find-nth-term` | **YES** — `find-nth-term` + `nth-term-steps` exist; confirm expression-format questions covered | Yes | No | 30 | [x] commit pending |
